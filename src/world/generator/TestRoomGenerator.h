...
#define ROW(name1, name2, name3, name4)                                                                                \
    std::array<TileType, 4>                                                                                            \
    {                                                                                                                  \
        TileType::name1, TileType::name2, TileType::name3, TileType::name4                                             \
    }
...
class TestRoomGenerator : public WorldGeneratorInterface
{
  public:
    static constexpr std::array<std::array<TileType, 4>, 4> ROOM = {
        ROW(InUpLeft, Down, Down, InUpRight), ROW(Right, Floor, Floor, Left), ROW(Right, Floor, Floor, Left),
